...
$valAjouter = Helper::addNewPddcasts($_POST);
?>
        ...
        <div class="content-wrapper" style="min-height: 562px;">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Page ajout podcast</h1>
                        </div>
            ...
            <section class="content">
                <div class="container-add">
                    ...
                    <form action="" method="POST">
                        <div>Titre podcast*</div>
                        <input type="text" class="form-control" placeholder="Titre podcast" name="titrePodcast" required>
                        
                        <br>
                        <div>Lien podcast*</div>
                        <textarea name="linkPodcast" placeholder="Lien podcast ici..."class = "form-control" cols="60%" rows="4" required></textarea>
