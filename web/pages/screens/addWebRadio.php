...
$valAjouter = Helper::addNewWebRadio($_POST);
?>
        ...
        <div class="content-wrapper" style="min-height: 562px;">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Page ajout web radio</h1>
                        </div>
            ...
            <section class="content">
                <div class="container-add">
                    ...
                    <form action="" method="POST">
                        <div>Titre WebRadio *</div>
                        <input type="text" class="form-control" placeholder="Titre WebRadio" name="titreWebRadio" required>

                        <div>Description WebRadio *</div>
                        <input type="text" class="form-control" placeholder="Description WebRadio" name="descriptionWebRadio" required>

                        <div>Lien WebRadio *</div>
                        <textarea name="linkPodcast" placeholder="Lien WebRadio ici..."class = "form-control" cols="60%" rows="4" required></textarea>
